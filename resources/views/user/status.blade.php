...
<body style="background-color: #6E3367;">
    ...
    <div class="card" style="width: 60rem; margin-top: 5rem; margin-left: 14rem; border-radius: 30px;">
        <div class="card-header border-dark">
            <div class="row">
                <div class="col-10">
                    <h5 class="card-title nama-lengkap" style="color: #6E3367; font-family: 'Poppins', sans-serif;">{{$status->nama_lengkap}}</h5>
                </div>
                <div class="col-2">
        ...
        <div class="card-body aspirasi" style="height: 10rem;">{{$status->aspirasi}}</div>
    </div>
    @endforeach
