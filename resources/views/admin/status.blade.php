...
<body style="background-color: #6E3367;">
    ...
    <div class="card" style="width: 60rem; margin-top: 5rem; margin-left: 14rem; border-radius: 30px;">
        <div class="card-header border-dark">
            <div class="row">
                <div class="col-10">
                    <h5 class="card-title" style="color: #6E3367; font-family: 'Poppins', sans-serif;">{{$datastatus->nama_lengkap}}</h5>
                </div>
                <div class="col-2">
        ...
        <div class="card-body" style="height: 10rem;">{{$datastatus->aspirasi}}</div>
    </div>
    @endforeach
